...
data_lmm <- data.frame(read.csv("visqst_unpl-only_tx-resp_cov-fmscore_outrem_forLMM.csv", # unpleasantness
                                 header = T, sep = ","))

data_lmm <- data.frame(read.csv("visqst_bright-only_tx-resp_cov-fmscore_outrem_forLMM.csv", # brightness
                                 header = T, sep = ","))
View(data_lmm)
